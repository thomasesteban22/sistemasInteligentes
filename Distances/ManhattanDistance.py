...
class ManhattanDistance(Distance):
    ...
    computation method to use the Manhattan metric, which is the
    sum of the absolute differences between the coordinates of
    the points.
    ...
    def __init__(self, point1, point2):
        ...
        try:
            ...
            raise ValueError(
                "Invalid arguments provided to ManhattanDistance."
            ) from e
    ...
    def compute_distance(self):
        ...
        differences between the corresponding coordinates of the
        two points.
        ...
        try:
            ...
            raise ValueError(
                "Error in computing Manhattan distance: " + str(e)
            ) from e
        except Exception as e:
            raise RuntimeError(
