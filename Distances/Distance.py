...
class Distance(ABC):
    ...
    Attributes:
        point1: The first point, which can be of any type that supports distance calculation.
        point2: The second point, which can be of any type that supports distance calculation.
    """
